...
// Feature: Native
// Description: Native mining software integration (Leica, Minelib, Vulcan)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Native. Native mining software integration (Leica, Minelib, Vulcan)' },
