...
// Autonomous
// Autonomous equipment maintenance scheduling from telematics + vibration data
...
export default function GapAutonomous() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Autonomous equipment maintenance scheduling from telematics + vibration data</p>
