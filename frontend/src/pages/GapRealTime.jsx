...
// Real Time
// Real-time safety anomaly detection across equipment + crew + environment
...
export default function GapRealTime() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Real-time safety anomaly detection across equipment + crew + environment</p>
