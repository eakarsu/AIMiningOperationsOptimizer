...
// Vertical
// Vertical integration with downstream processors (mine-to-mill agent)

export default function GapVertical() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-vertical', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Vertical</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Vertical integration with downstream processors (mine-to-mill agent)</p>
