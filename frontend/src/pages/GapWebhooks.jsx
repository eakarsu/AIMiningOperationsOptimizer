...
// Webhooks
// Webhooks for OEM equipment vendors

export default function GapWebhooks() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-webhooks', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Webhooks</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Webhooks for OEM equipment vendors</p>
